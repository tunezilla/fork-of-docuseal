...
module Docuseal
  ...
  PRODUCT_URL = ENV.fetch('PRODUCT_URL', 'https://www.docuseal.co')
  ...
  SUPPORT_EMAIL = ENV.fetch('SUPPORT_EMAIL', 'support@docuseal.co')
  ...
  CONSOLE_URL = if Rails.env.development?
                  ...
                  ENV.fetch('CONSOLE_URL', 'https://console.docuseal.co')
                end
  CLOUD_URL = if Rails.env.development?
                'http://localhost:3000'
              else
                ENV.fetch('CLOUD_URL', 'https://docuseal.co')
              end
  CDN_URL = if Rails.env.development?
              ...
              ENV.fetch('CDN_URL', 'https://cdn.docuseal.co')
            end
